 ...
 * pari a QUIT_STRING.
 * Riceve in multicast e peremtte a più processi di usare lo stesso numero di porta.
 *
...
// imposta  l'interfaccia sulla quale sarà avviata la trasmissione multicast
// ovvero la prima disponibile

     ipmreq.imr_interface.s_addr = htonl(INADDR_ANY);

// Permette di collegare il processo allo stesso numero di porta anche se già
...
// finalmente il socket è collegato
